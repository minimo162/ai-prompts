...
$names = @('Test-CsvContracts.ps1','Test-CsvBatch.ps1','Test-CsvLifecycle.ps1','Test-OfflineDiagnostic.ps1')
if ($Suite -ceq 'All') { $names += @('Test-App.ps1','Test-Pad.ps1','Test-Copilot.ps1','Test-CopilotPlannerV2.ps1','Test-PlannerV2Transport.ps1','Test-Http.ps1','Test-Launcher.ps1','Test-PublishAgentSource.ps1','Test-AiCallProcess.ps1','Test-AiCallProviderFailure.ps1','Test-ClipboardSnapshot.ps1') }
