...
if ($Suite -ceq 'All') { $names += @('Test-ConversationScope.ps1','Test-ConnectionContract.ps1','Test-AcceptanceGate.ps1','Test-App.ps1','Test-Pad.ps1','Test-RobinCatalog.ps1','Test-GeneralJobStart.ps1','Test-PadRecovery.ps1','Test-Copilot.ps1','Test-CopilotPlannerV2.ps1','Test-PlannerV2Transport.ps1','Test-Http.ps1','Test-Launcher.ps1','Test-ReleaseBinding.ps1','Test-PublishAgentSource.ps1','Test-PublishCrash.ps1','Test-AiCallProcess.ps1','Test-AiCallProviderFailure.ps1','Test-ClipboardSnapshot.ps1') }
